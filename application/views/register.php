...
<input type="text" name="first_name" id="first_name" value="<?php echo set_value('first_name'); ?>" class="form-control <?php //echo (form_error('first_name') != "") ? 'is_invalid' : ''; ?>"  placeholder="First Name">
...
<input type="text" name="address" id="address" value="<?php echo set_value('address'); ?>" class="form-control" placeholder="Address">
<?php echo form_error('address'); ?>
</div>


<div class="form-group">
  <button class="btn btn-block btn-primary col-md-12">Create</button>
</div>
